...
public class Purify {
	public static void main(String[] args) {
		...
		MongoDatabase db = mongoClient.getDatabase(MongoDBUtil.DB_NAME);
                             // ¡°/User/xxx/Downloads¡±
		String fileName = "C:\\Users\\Dylan Hong\\Desktop\\Laioffer Full stack Summer 3\\tomcat_log.txt";
		try {
			// drop if anything exists before
			...
			while ((line = bufferedReader.readLine()) != null) {
				...
				// formal language
				// ? means we want the part before ? is as short as possible
