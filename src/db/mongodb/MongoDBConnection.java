...
public class MongoDBConnection implements DBConnection {
	...
	public void saveItem(Item item) {
		...
		db.getCollection("items").updateOne(new Document().append("item_id", item.getItemId()),	new Document("$set",new Document()
				.append("item_id", item.getItemId()).append("name", item.getName())
